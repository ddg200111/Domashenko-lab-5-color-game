...
public class MainActivity extends AppCompatActivity {
    ...
    List<String> listNames = new ArrayList<> (Arrays.asList("Червоний", "Зелений", "Синій", "Чорний", "Пурпуровий"));
    List<Integer> listColors = new ArrayList<>( Arrays.asList(Color.RED, Color.GREEN, Color.BLUE, Color.BLACK, Color.MAGENTA));
